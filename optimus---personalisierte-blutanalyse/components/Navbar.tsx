...
const Navbar: React.FC<NavbarProps> = ({ onNavigate, onLogout, currentPage, isLoggedIn }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-6 py-5">
      <div className="max-w-7xl mx-auto flex items-center justify-between medical-nav-shell rounded-3xl px-8 py-3.5 premium-border">
        <div 
          className="flex items-center gap-3 cursor-pointer group"
          onClick={() => onNavigate('home')}
        >
          <div className="w-9 h-9 medical-logo-badge flex items-center justify-center font-[900] text-xl group-hover:scale-105 transition-transform text-white shadow-lg">O</div>
