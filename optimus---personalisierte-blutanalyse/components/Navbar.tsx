...
const Navbar: React.FC<NavbarProps> = ({ onNavigate, onLogout, currentPage, isLoggedIn }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-6 py-3.5">
      <div className="max-w-7xl mx-auto flex items-center justify-between medical-nav-shell rounded-3xl px-6 py-2.5 premium-border">
        <div 
        ...
        >
          ...
          <span className="text-xl font-[900] tracking-[-0.05em] uppercase text-[#0F172A]">Optimus</span>
        </div>
